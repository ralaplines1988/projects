...
const renderJsonResponse = (res) => {
  ...
  rawJson = JSON.stringify(rawJson).replace(/,/g, ", \n") //stringify rawJson then replace all , to \n, brower will interpret them as a breakline
  // manipulates responseField to show the returned JSON.
  responseField.innerHTML = `<pre>${rawJson}</pre>` //use <pre> to keep the format of rawJson
}
